...
<head>
  ...
  <style>
    body {
      ...
      overflow: hidden;
      text-align: center;
      background: linear-gradient(135deg, #ffb6d5, #ffc2e2);
      position: relative;
    }

    /* Corazones gigantes de fondo */
    .bg-heart {
      position: absolute;
      font-size: 200px;
    ...
    .bg1 { top: 5%; left: 5%; }
    .bg2 { bottom: 10%; right: 5%; }
    .bg3 { top: 30%; right: 20%; font-size: 250px; }
...
<body>
  ...
  <div class="bg-heart bg1">❤</div>
  <div class="bg-heart bg2">❤</div>
